...
This skill adapts Andrej Karpathy's autoresearch methodology (autonomous experimentation loops) to opencode skills. Instead of optimizing ML training code, we optimize skill prompts.
